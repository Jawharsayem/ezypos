                        ...
                        actions: [
                          TextButton(
                            onPressed: () async {
                              ...
                              Future.delayed(Duration(milliseconds: 1000)).then((value) => Navigator.pushNamedAndRemoveUntil(context, '/Parties', (route) => false));
                            }, // Yes means pop
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () async {
                        final email = widget.customerModel.emailAddress;

                        if (email!.isEmpty) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('No email available for this customer')),
                          );
                          return;
                        }
                        ...
                        final Uri emailUri = Uri(
                          scheme: 'mailto',
                          path: email,
                          query: Uri.encodeFull('subject=Hello&body=Hello, I would like to...'),
                        );
