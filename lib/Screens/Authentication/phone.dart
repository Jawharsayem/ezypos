                    ...
                    try {
                      await FirebaseAuth.instance.verifyPhoneNumber(
                        ...
                        verificationFailed: (FirebaseAuthException e) {
                          EasyLoading.dismiss();
                          EasyLoading.showError('Verification Failed: ${e.message}');
                        },
                        ...
                        codeAutoRetrievalTimeout: (String verificationId) {
                          // Handle timeout if the code is not retrieved automatically
                          EasyLoading.dismiss();
                          EasyLoading.showInfo('Timeout. Please enter the code manually.');
                        },
                      );
                    } catch (e) {
                      EasyLoading.dismiss();
