        ...
        body: Padding(
          ...
          child: Column(
            children: [
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: GestureDetector(
                      onTap: () => const AddExpenseCategory().launch(context),
                      child: Container(
                        ...
                        child: const Icon(Icons.add, color: kGreyTextColor),
                      ),
                    ),
                  ),
                ],
              ...
              // Data display with proper loading handling
              Expanded(
                child: data.when(
                  data: (categories) {
...
//                     print("---data length--${data[index].categoryName}------------");
//                     return Padding(
