...
class _PurchasePremiumPlanScreenState extends State<PurchasePremiumPlanScreen> {
  ...
  String calculateDiscount(int offerPrice, int subscriptionPrice) {
    if (subscriptionPrice == 0 || offerPrice >= subscriptionPrice) {
      return '0';
    }
    double discount = 100 - ((offerPrice * 100) / subscriptionPrice);
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                const SizedBox(height: 5),
                                                Text(
                                                  'Duration ${data[index].duration} Days',
                                          ...
                                          Positioned(
                                            ...
                                            child: Container(
                                              ...
                                              child: Center(
                                                child: Text(
                                                  '${lang.S.of(context).save} ${calculateDiscount(data[index].offerPrice, data[index].subscriptionPrice)}%',
