                ...
                children: [
                  Material(
                    ...
                    shape: RoundedRectangleBorder(
                        ...
                        side: BorderSide(color: whichPaymentIsChecked == 'Paypal' ? primaryColor : kGreyTextColor.withValues(alpha: 0.2))),
                    color: Colors.white,
                  ...
                  //   shape: RoundedRectangleBorder(
                  //       borderRadius: BorderRadius.circular(10.0),
                  //       side: BorderSide(color: whichPaymentIsChecked == 'Stripe' ? primaryColor : kGreyTextColor.withValues(alpha: 0.1))),
                  //   color: Colors.white,
                  //   child: CheckboxListTile(
                  ...
                  Material(
                    ...
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0),
                        side: BorderSide(color: whichPaymentIsChecked == 'Paytm' ? primaryColor : kGreyTextColor.withValues(alpha: 0.2))),
                    color: Colors.white,
                    child: CheckboxListTile(
                  ...
                  //   elevation: 0.0,
                  //   shape: RoundedRectangleBorder(
                  //       borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'Razorpay' ? primaryColor : kGreyTextColor.withValues(alpha: 0.2))),
                  //   color: Colors.white,
                  //   child: CheckboxListTile(
                  ...
                  Material(
                    ...
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0),
                        side: BorderSide(color: whichPaymentIsChecked == 'SSLCommerz' ? primaryColor : kGreyTextColor.withValues(alpha: 0.2))),
                    color: Colors.white,
                    child: CheckboxListTile(
                  ...
                  Material(
                    elevation: 0.0,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'Tap' ? primaryColor : kGreyTextColor.withValues(alpha: 0.2))),
                    color: Colors.white,
                    child: CheckboxListTile(
                  ...
                  Material(
                    ...
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0),
                        side: BorderSide(color: whichPaymentIsChecked == 'Flutterwave' ? primaryColor : kGreyTextColor.withValues(alpha: 0.2))),
                    color: Colors.white,
                    child: CheckboxListTile(
