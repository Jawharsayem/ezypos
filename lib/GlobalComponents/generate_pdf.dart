...
class GeneratePdf {
  Future<void> generatePurchaseDocument(
    ...
    if (Platform.isIOS) {
      ...
      final file = File(
          '${dir.path}/${'Salespro_purchase_${personalInformation.companyName}-${transactions.invoiceNumber}'}.pdf');
  ...
  Future<void> generateSaleDocument(
                  ...
                  children: [
                    pw.Column(
                      ...
                      children: [
                        ...
                        pw.Container(
                          ...
                          child: pw.Row(
                              ...
                              children: [
                                ...
                                // ),
                                pw.Text(
                                  "Paid Amount: ${(transactions.totalAmount ?? 0.0) - (transactions.dueAmount ?? 0.0)}",
                                  style: pw.TextStyle(
                                    color: PdfColors.black,
                                    fontWeight: pw.FontWeight.bold,
                                  ),
                        ...
                        //   ),
                        // ),
                        pw.Text("Due Amount: ${transactions.dueAmount ?? 0.0}",
                            style: pw.TextStyle(
                              color: PdfColors.red,
                              fontWeight: pw.FontWeight.bold,
                            )),
    ...
    if (Platform.isIOS) {
      ...
      final dir = await getApplicationDocumentsDirectory();
      final file = File(
          '${dir.path}/${'Salespro_sale${personalInformation.companyName}-${transactions.invoiceNumber}'}.pdf');
    ...
    if (Platform.isAndroid) {
      ...
      Directory dir = Directory(downloadsFolderPath);
      final file = File(
          '${dir.path}/${'Salespro_sale_${personalInformation.companyName}-${transactions.invoiceNumber}'}.pdf');
  ...
  Future<void> generateDueDocument(
    ...
    if (Platform.isIOS) {
      ...
      final dir = await getApplicationDocumentsDirectory();
      final file = File(
          '${dir.path}/${'Salespro_due${personalInformation.companyName}-${transactions.invoiceNumber}'}.pdf');
    ...
    if (Platform.isAndroid) {
      ...
      Directory dir = Directory(downloadsFolderPath);
      final file = File(
          '${dir.path}/${'Salespro_due_${personalInformation.companyName}-${transactions.invoiceNumber}'}.pdf');
